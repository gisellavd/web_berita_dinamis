            ...
            <?php
                if(isset($_GET['komentar'])) {
                    if ($_GET['komentar']=='berhasil') {
                        echo"<div class='alert alert-success'>Komentar terkirim, tunggu acc dari admin</div>";
                    } else {
                        echo"<div class='alert alert-fail'>Komentar gagal terkirim</div>";
                    }
                }
            ?>
            <div class="row">
                ...
                <form method="post" action="save-komen.php">
                    <label><h2>Beri Komentar</h2></label>
